        ...
        <section class="cadastro-lead">
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-6">
                        <h2><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Depoimento</h2>
                        <blockquote>
                            <p class="mb0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta, odit. Deserunt doloremque earum magni a maxime similique ullam nam minus dignissimos nostrum exercitationem, laboriosam suscipit facere voluptatum perspiciatis repudiandae voluptatem.</p>
                        </blockquote>
                    </div><!--col-md-->
                </div><!--row-->
            </div><!--container-->
        ...
        <section class="diferenciais text-center">
            ...
            <div class="container diferenciais-container">
                <div class="row">
                    <div class="col-md-4">
                        <h3>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-nvidia" viewBox="0 0 16 16">
                        ...
                        <h2>diferenciais</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, aliquam explicabo placeat repellat similique magnam soluta, ullam asperiores pariatur exercitationem cupiditate eius necessitatibus deleniti sit qui autem dolor. Nostrum, nobis.</p>
                    </div>
                    <div class="col-md-4">
                        <h3>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-amd" viewBox="0 0 16 16">
                                <path d="m.334 0 4.358 4.359h7.15v7.15l4.358 4.358V0zM.2 9.72l4.487-4.488v6.281h6.28L6.48 16H.2z" />
                            </svg>

                        </h3>
                        <h2>diferenciais</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem quasi sapiente enim saepe hic totam ipsam officia quae cumque odio, nobis rerum nulla fuga tempore assumenda, esse, natus magni explicabo.</p>
                    ...
                    <div class="col-md-4">
                        ...
                        <h2>diferenciais</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi vero nostrum harum enim ad laudantium, perspiciatis iste voluptates a laboriosam eos sit expedita natus tempore. Iusto velit magni facere beatae?</p>
                    </div>
                </div><!--row-->
            </div><!--container-->
